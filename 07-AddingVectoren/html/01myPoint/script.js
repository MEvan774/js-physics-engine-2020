...
C = new Point(300,400,20,"blue",true);

D = new Point(100,100,10,"orange",false);
E = new Point(500,200,10,"brown",false);
F = new Point(300,400,10,"pink",false);
...
function animate(){
	...
	d.vectorSun(A.vPos,trans);
	e.vectorSun(B.vPos,trans);
	f.vectorSun(C.vPos,trans);
